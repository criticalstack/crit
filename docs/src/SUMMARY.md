...
- [Crit Guide](crit-guide/overview.md)
  ...
  - [Kubernetes Certificates](crit-guide/kubernetes-certificates.md)
    - [Generating Certificates](crit-guide/generating-certificates.md)
    - [Managing Certificates](crit-guide/managing-certificates.md)
  ...
  - [Running crit up](crit-guide/running-crit-up.md)
    - [Control Plane Nodes](crit-guide/crit-up-control-plane-node.md)
    - [Worker Nodes](crit-guide/crit-up-worker-node.md)
